      ...
      <div className='form-control'>
        ...
        <div>
          {categories.map((c,index)=>{
            return <button key={index} onClick={updateFilters} name="category" type="button" className={`${category.toLowerCase()===c.toLowerCase()?'active':null}`}>
              {c}
            </button>
          })}
        </div>
